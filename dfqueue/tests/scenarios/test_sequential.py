...
def test_sequential_1(queue_name):
    ...
    assert QueuesHandler()._QueuesHandler__queues[queue_name] == deque([("1",
                                                                         {'B': 2.0, 'D': 4.0})])
    ...
    assert len(dataframe) == 2
    assert QueuesHandler()._QueuesHandler__queues[queue_name] == deque([("2",
                                                                         {'B': 6.0, 'D': 8.0}),
                                                                        ("3",
                                                                         {'B': 10.0, 'D': 12.0})])
    ...
    assert len(dataframe) == 2
    assert QueuesHandler()._QueuesHandler__queues[queue_name] == deque([("5",
                                                                         {'B': 18.0, 'D': 20.0}),
                                                                        ("6",
                                                                         {'B': 22.0, 'D': 24.0})])
